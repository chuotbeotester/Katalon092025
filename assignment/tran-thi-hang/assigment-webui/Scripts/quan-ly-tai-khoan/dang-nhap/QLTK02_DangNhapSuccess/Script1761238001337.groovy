...
'Nhập email'
WebUI.setText(findTestObject('quan-ly-tai-khoan/dang-nhap/iptEmailDangNhap'), GlobalVariable.email)

'Nhập password'
WebUI.setText(findTestObject('quan-ly-tai-khoan/dang-nhap/iptPasswordDangNhap'), GlobalVariable.password)
...
assert actualTextName.equals('Logged in as ' + GlobalVariable.name)
