...
'4. Message lỗi Your email or password is incorrect! được hiển thị'
messageError = WebUI.getText(findTestObject('quan-ly-tai-khoan/dang-nhap/txtMessageIncorrect'))
assert messageError.equals('Your email or password is incorrect!')
