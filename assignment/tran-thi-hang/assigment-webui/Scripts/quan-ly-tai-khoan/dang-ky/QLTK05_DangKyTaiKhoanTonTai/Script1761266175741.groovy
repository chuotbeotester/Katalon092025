...
'Verify hien thi message Email tồn tại'
textEmailExist = WebUI.getText(findTestObject('quan-ly-tai-khoan/dang-ky/txtEmailExsit'))
assert textEmailExist.equals('Email Address already exist!')