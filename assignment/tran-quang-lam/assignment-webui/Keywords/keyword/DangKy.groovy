...
public class DangKy {
	public static def signup(String name, String email, String password, String days, String months, String years
		...
		'ACCOUNT CREATED! được hiển thị'
		HelperKeywords.verifyTextEqual(findTestObject('dat-hang-va-thanh-toan/txtCreatedAccount'), 'ACCOUNT CREATED!')
